...
interface StreamingMusicControlProps {
...
export const StreamingMusicControl = ({
  audioQueue,
  currentlyPlayingId,
  isShuffled,
  isRepeating,
        ...
        <div className="px-6 py-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 min-w-0 flex-1">
              <div className="relative">
                <div className="w-16 h-16 bg-gradient-to-br from-purple-500 via-pink-500 to-violet-500 rounded-xl flex items-center justify-center shadow-lg shadow-purple-500/25">
                ...
                {hasPlayingTracks && (
                  <div className="absolute -top-1 -right-1 w-5 h-5 bg-green-500 rounded-full border-2 border-black animate-pulse flex items-center justify-center">
                    <div className="w-2 h-2 bg-white rounded-full"></div>
                  </div>
                )}
              </div>
              <div className="min-w-0 flex-1">
                <p className="text-white font-bold truncate text-xl">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button
                ...
                className="text-purple-300 hover:text-white hover:bg-purple-800/30 transition-all duration-300"
              ...
              <Button
                ...
                } text-white rounded-full p-4 transform transition-all duration-300 hover:scale-110 active:scale-95`}
                disabled={audioQueue.length === 0}
              >
                {hasPlayingTracks ? <Pause className="h-7 w-7" /> : <Play className="h-7 w-7 ml-1" />}
              </Button>
            ...
            <div className="flex items-center space-x-4 min-w-0 flex-1 justify-end">
              ...
              <Popover open={showQueue} onOpenChange={setShowQueue}>
                <PopoverTrigger asChild>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="text-purple-300 hover:text-white hover:bg-purple-800/30 relative transition-all duration-300"
                  >
                ...
                <PopoverContent className="w-96 bg-black/95 border-purple-800/50 backdrop-blur-xl">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h3 className="font-bold text-purple-200">Queue</h3>
                      <div className="flex items-center space-x-2 text-xs text-purple-400">
                        {isShuffled && <span className="bg-green-500/20 text-green-400 px-2 py-1 rounded">Shuffled</span>}
                        {isRepeating && <span className="bg-green-500/20 text-green-400 px-2 py-1 rounded">Repeat</span>}
                      </div>
                    </div>
                          ...
                          <div
                            ...
                            className={`p-3 rounded-lg border transition-all ${
                              track.id === currentlyPlayingId
                                ? 'bg-purple-900/60 border-purple-500/60 shadow-lg'
                                : 'bg-black/40 border-purple-900/40 hover:bg-black/60'
                            }`}
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-3 min-w-0 flex-1">
                                <span className="text-purple-400 text-xs w-6">{index + 1}</span>
                                <Button
                                  variant="ghost"
                                  size="sm"
              ...
              <Popover open={showSettings} onOpenChange={setShowSettings}>
                ...
                <PopoverContent className="w-80 bg-black/95 border-purple-800/50 backdrop-blur-xl">
                  <div className="space-y-4">
                    <h3 className="font-bold text-purple-200">Audio Settings</h3>
          ...
          <div className="flex items-center space-x-3 mt-4">
            ...
            <div className="flex-1 h-2 bg-purple-900/50 rounded-full overflow-hidden">
              <div className={`h-full bg-gradient-to-r from-purple-500 to-violet-500 ${hasPlayingTracks ? 'w-1/3 animate-pulse' : 'w-0'} transition-all duration-300 rounded-full`}></div>
            </div>
